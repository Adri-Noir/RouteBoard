  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent className="overflow-hidden p-0">
        <Command
          filter={filter}
          className="[&_[cmdk-group-heading]]:text-muted-foreground **:data-[slot=command-input-wrapper]:h-12 [&_[cmdk-group-heading]]:px-2
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        ...
        py-1.5 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50
