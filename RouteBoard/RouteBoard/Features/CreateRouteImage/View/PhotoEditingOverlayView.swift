...
//  RouteBoard
//
//  Created by Adrian Cvijanovic on 20.12.2024..
//
                ...
                .gesture(
                    DragGesture(minimumDistance: 1)
                        .onChanged { value in
                            ...
                            let photoMatrixWidth = createRouteImageModel.photoMatrix?.cols() ?? Int32(geometry.size.width)
                            let photoMatrixHeight = createRouteImageModel.photoMatrix?.rows() ?? Int32(geometry.size.height)
