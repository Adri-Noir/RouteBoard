...
Homografija je projektivna transformacija u 2D prostoru koja preslikava točke iz jedne ravnine u drugu~\cite{foundationsCVbook}. U ovom slučaju te ravnine su referentna slika i slika dobivena s kamere. Homografija se može opisati matričnom jednadžbom
\begin{equation}
    \lambda *
    \begin{bmatrix}
        x' \\
